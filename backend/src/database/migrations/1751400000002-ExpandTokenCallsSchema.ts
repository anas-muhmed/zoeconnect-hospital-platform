 ...
 */
/** @deprecated Renamed to 1751400000003-ExpandTokenCallsSchema to avoid timestamp collision. Do not use. */
export class ExpandTokenCallsSchema1751400000002 implements MigrationInterface {
  name = 'ExpandTokenCallsSchema1751400000002';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Soft FK — no hard constraint to avoid failures if token_records rows are missing
    // for tokens issued before GAP-1 fix. Index only.
    await queryRunner.query(`
